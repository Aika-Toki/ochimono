...
const FRICTION = 0.03; // 摩擦
const MAX_FRICTION = 0.03;
// const MAX_FRICTION = 100;
const RANDOM_FRICTION = 3;
const MASS = 30; // 重量
const MAX_LEVEL = 10;
...
const BUBBLE_TEXTURES = {
  0: ["./Assets/Images/th06_00/_.png", 0.16], // Daiyousei
  1: ["./Assets/Images/th06_01/_.png", 0.23], // Rumia
  2: ["./Assets/Images/th06_02/_.png", 0.305], // Cirno
  3: ["./Assets/Images/th06_03/_.png", 0.375], // Meirin
  4: ["./Assets/Images/th06_04/_.png", 0.475], // Koakuma
  5: ["./Assets/Images/th06_05/_.png", 0.55], // Patchouli
  6: ["./Assets/Images/th06_06/_.png", 0.63], // Sakuya
  7: ["./Assets/Images/th06_07/_.png", 0.71], // Remilia
  8: ["./Assets/Images/th06_08/_.png", 0.79], // Flandre
  9: ["./Assets/Images/th06_09/_.png", 0.87], // Marisa
  10: ["./Assets/Images/th06_10/_.png", 0.95], // Reimu
};
...
class BubbeGame {
  ...
  createNewBubble() {
    ...
    const currentBubble = Bodies.circle(this.defaultX, 30, radius, {
      isSleeping: true,
      label: "bubble_" + level,
      friction: Math.floor(Math.random() * RANDOM_FRICTION) == 0 ? MAX_FRICTION : FRICTION,
      mass: MASS,
      collisionFilter: {
        group: 0,
